...
At the end of each episode, the global visitation counts $N_k(s,a)$ are updated with the values stored in $v_k(s, a)$ for each pair of state and action.
...
\end{assumption}
Lemma 3 of \cite{fruit_exploration--exploitation_2017} shows that under these assumptions, the family of SMDPs induced by extending MDPs with options is such that for each of the options, the distributions of the cumulative reward and the duration of options are sub-exponential.
